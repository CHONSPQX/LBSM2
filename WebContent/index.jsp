...
try{
	...
	con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost/test?useSSL=false","root","126459");
	Statement statement=con.createStatement();
    result=statement.executeQuery("select * from test.admin where name='"+uname+"' and pwd='"+pwd+"'");
	//pst=con.prepareStatement("select * from admin where name=\""+uname+"\" and pwd=\""+pwd+"\"");
