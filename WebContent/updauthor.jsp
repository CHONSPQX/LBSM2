...
<body>
	<div class="container">
		...
		<div class="tabbable tabs-below">
			<ul class="nav nav-pills">
				...
				<li><a href="delauthor.jsp">Delete Author</a></li>
				<li class="active"><a href="updauthor.jsp">Update Author</a></li>
	...
	<div id="wrap">
		<div class="container">
			...
			<p>Update Author By AuthorID(PK)</p>
				...
				try 
				{
					if (session_user != null) 
					{
						...
						if (submit != null) 
						{
							...
							Connection con = null;
							PreparedStatement pstUpdateItem = null;
							try 
							{
								Class.forName("com.mysql.jdbc.Driver");
								con = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?useSSL=false", "root",
										"126459");
								String sqlUpdateItem = "update test.author set Name='"+name+"',Age='"+age+
										"',Country='"+country+"' where AuthorID='"+authorid+"'";
								pstUpdateItem = con.prepareStatement(sqlUpdateItem);
								pstUpdateItem.executeUpdate();
								out.println("Success fully Updated");
